...
public class AdapterHome extends BaseAdapter {
    ...
    public AdapterHome(Context contexto, List<Comentario> timeLineList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch (tipo){
            case 1:
                ...
                v = LayoutInflater.from(contexto).inflate(R.layout.corpo_home_post, viewGroup, false);

                CircleImageView imgUsuario = (CircleImageView) v.findViewById(R.id.imgUsuario);
                ImageLoader downImg = new ImageLoader(imgUsuario);
