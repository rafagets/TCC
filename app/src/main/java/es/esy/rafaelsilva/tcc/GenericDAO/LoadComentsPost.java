...
import es.esy.rafaelsilva.tcc.adapters.AdapterComentariosPost;
 ...
 */
public class LoadComentsPost extends AsyncTask<String, Void, Boolean> {

    private ProgressBar bar;
    private Context contexto;
    private List<ComentarioPost> comentarios;

    public LoadComentsPost(Context contexto) {
    ...
    protected void onPostExecute(Boolean flag) {
        ...
        AdapterComentariosPost adapter = new AdapterComentariosPost(comentarios, contexto);
