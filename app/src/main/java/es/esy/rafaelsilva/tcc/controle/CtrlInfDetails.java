 ...
 */
public class CtrlInfDetails implements Retorno {
    private Context contexto;

    public CtrlInfDetails(Context contexto) {
    ...
    public void trazer(int codigo, final CallbackTrazer callback){
        ...
        params.put("acao", "R");
        params.put("tabela", "detalhes");
        params.put("condicao", "produto");
        params.put("valores", String.valueOf(codigo));

        GetData<Detalhes> getData = new GetData<>("objeto", params);
        getData.executar(Detalhes.class, new CallBackDAO() {
            @Override
    ...
    public void listar(String parametro, final CallbackListar callback){
        ...
        GetData<Detalhes> getData = new GetData<>("lista", params);
        getData.executar(Detalhes.class, new CallBackDAO() {
            @Override
            public void sucesso(Object resposta) {
