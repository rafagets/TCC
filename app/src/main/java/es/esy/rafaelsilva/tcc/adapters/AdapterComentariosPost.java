 ...
 */
public class AdapterComentariosPost extends RecyclerView.Adapter<AdapterComentariosPost.MyViewHolder> {

    private List<ComentarioPost> comentarios;
    private Context contexto;

    public AdapterComentariosPost(List<ComentarioPost> comentarios, Context contexto) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.comentario_post_inflate, parent, false);
